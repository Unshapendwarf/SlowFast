...
if [ $MACHINE_NAME = "mango2" ];then
    ...
    # CUDA_VISIBLE_DEVICES=1 /home/hong/anaconda3/envs/torch10/bin/python tools/run_net.py --cfg configs/Kinetics/custom_mvit_32.yaml
    ...
    # CUDA_VISIBLE_DEVICES=1 /home/hong/anaconda3/envs/torch10/bin/python tools/run_net.py --cfg configs/masked_ssl/k400_VIT_L_16x4_MAE_PT.yaml
