...
def test(cfg):
    ...
    for num_view in cfg.TEST.NUM_TEMPORAL_CLIPS:
        ...
        if cfg.DETECTION.ENABLE:
            ...
            test_meter = TestMeter(
                599 // (cfg.TEST.NUM_ENSEMBLE_VIEWS * cfg.TEST.NUM_SPATIAL_CROPS),
                cfg.TEST.NUM_ENSEMBLE_VIEWS * cfg.TEST.NUM_SPATIAL_CROPS,
    ...
    for view, test_meter in zip(cfg.TEST.NUM_TEMPORAL_CLIPS, test_meters):
        ...
        result_string = "_p{:.2f}_f{:.2f}_{}a{} Top5 Acc: {} MEM: {:.2f} f: {:.4f}" "".format(
            params / 1e6,
            flops,
            view,
